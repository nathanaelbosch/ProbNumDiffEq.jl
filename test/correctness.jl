...
CONSTANT_ALGS = (
    ...
    EK0(order=3, smooth=false, initialization=ClassicSolverInit()) => 3e-7,
    ...
    EK1(order=3, smooth=false, initialization=ClassicSolverInit()) => 3e-7,
    ...
    DiagonalEK1(order=3, smooth=false, initialization=ClassicSolverInit()) => 3e-7,
    # smoothing
    ...
    DiagonalEK1(order=3, smooth=true, initialization=ClassicSolverInit()) => 3e-7,
    # Priors
...
ADAPTIVE_ALGS = (
    ...
    EK0(order=3, initialization=SimpleInit()) => 2e-4,
    ...
    EK1(order=3, initialization=SimpleInit()) => 2e-4,
    ...
    EK0(prior=Matern(3, 1), smooth=true) => 2e-4,
