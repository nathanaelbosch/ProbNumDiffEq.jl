...
CONSTANT_ALGS = (
    ...
    EK0(order=3, smooth=false, initialization=ClassicSolverInit(Tsit5())) => 1e-7,
    ...
    EK1(order=3, smooth=false, initialization=ClassicSolverInit(Tsit5())) => 1e-7,
...
ADAPTIVE_ALGS = (
    ...
    EK1(order=5) => 1e-6,
    EK1(order=8) => 5e-6,
    EK1(order=3, initialization=ClassicSolverInit(Tsit5())) => 1e-5,
