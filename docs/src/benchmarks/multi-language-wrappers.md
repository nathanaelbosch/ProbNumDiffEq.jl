...
# We use include_string to evaluate the fix inside the deSolveDiffEq module where RCall
# and DiffEqBase are available (they are transitive deps, not directly importable here).
